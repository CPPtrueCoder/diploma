...
return B;
 ...
 function printMatrix(){
	 ...
	 res ='<center><b>Решение лабораторной работы по теме: <br/>"Полный факторный экперимент".</center><br/>Ваша матрица планирования (X):</b><br/>';
	 Obj.txt+= 'Решение лабораторной работы по теме: "Полный факторный экперимент".\r\nВаша матрица планирования (Х):\r\n\r\n';
