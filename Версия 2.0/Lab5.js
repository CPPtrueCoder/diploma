...
if (document.getElementById('umnozh')!=''){
  ...
  for (var i = 0; i < N; i++)
    ...
    var D1 = Matrix(N,X); 
	D1 = multMatrix(A,A);
Obj.txt+= 'Решение лабораторной работы по теме: Цепи Маркова. Начальные данные:\r\nПервая матрица:\r\n\r\n';
for (i=0;i<N;i++){
for (j=0;j<N;j++){
Obj.txt+= A[i][j] + '  ';
}
...
var res = '<center><b>Решение лабораторной работы по теме:<br/>"Цепи Маркова"</b></center><br/>';
